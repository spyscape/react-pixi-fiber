(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('pixi.js'), require('react'), require('prop-types')) :
  typeof define === 'function' && define.amd ? define(['exports', 'pixi.js', 'react', 'prop-types'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ReactPixiFiber = {}, global.PIXI, global.React, global.PropTypes));
})(this, (function (exports, PIXI, React, PropTypes) { 'use strict';
  ...
  function createInjectedTypeInstance(type, props, rootContainer, hostContext, internalHandle, applyDisplayObjectProps) {
    var instance;
  ...
  // http://pixijs.download/release/docs/PIXI.DisplayObject.html
  var displayObjectStandardNames = _objectSpread2(_objectSpread2({}, eventsStandardNames), {}, {
    alpha: "alpha",
    angle: "angle",
  ...
  var containerStandardNames = _objectSpread2(_objectSpread2({}, displayObjectStandardNames), {}, {
    height: "height",
  ...
  var spriteStandardNames = _objectSpread2(_objectSpread2({}, containerStandardNames), {}, {
    anchor: "anchor",
    blendmode: "blendMode",
  ...
  var bitmapTextStandardNames = _objectSpread2(_objectSpread2({}, containerStandardNames), {}, {
    align: "align",
    anchor: "anchor",
    font: "font",
  ...
  var graphicsStandardNames = _objectSpread2(_objectSpread2({}, containerStandardNames), {}, {
    blendmode: "blendMode",
    geometry: "geometry",
    pluginname: "pluginName",
    tint: "tint"
  ...
  var particleContainerStandardNames = _objectSpread2(_objectSpread2({}, containerStandardNames), {}, {
  ...
  var textStandardNames = _objectSpread2(_objectSpread2({}, spriteStandardNames), {}, {
    canvas: "canvas",
    context: "context",
  ...
  var tilingSpriteStandardNames = _objectSpread2(_objectSpread2({}, spriteStandardNames), {}, {
  ...
  var possibleStandardNames = _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, TYPES.BITMAP_TEXT, bitmapTextStandardNames), TYPES.CONTAINER, containerStandardNames), TYPES.GRAPHICS, graphicsStandardNames), TYPES.PARTICLE_CONTAINER, particleContainerStandardNames), TYPES.SPRITE, spriteStandardNames), TYPES.TEXT, textStandardNames), TYPES.TILING_SPRITE, tilingSpriteStandardNames);
  ...
  function createPixiApplication(options) {
    return new PIXI__namespace.Application(options);
  }
  ...
  function setPixiValue(instance, propName, value) {
    if (isPointType(instance[propName]) && isPointType(value)) {
      ...
      invariant_1(typeof coordinateData !== "undefined" && coordinateData.length > 0 && coordinateData.length < 3, "The property `%s` is a PIXI.Point or PIXI.ObservablePoint and must be set to a comma-separated string of " + "either 1 or 2 coordinates, a 1 or 2 element array containing coordinates, or a PIXI Point/ObservablePoint. " + "If only one coordinate is given then X and Y will be set to the provided value.%s", propName, getStackAddendum());
  ...
  // When falsy, it should be removed.
  var CALLBACK = 6;
  function shouldIgnoreAttribute(type, name, propertyInfo) {
  ...
  function shouldRemoveAttributeWithWarning(type, name, value, propertyInfo) {
  ...
  function shouldRemoveAttribute(type, name, value, propertyInfo) {
    ...
    if (propertyInfo !== null) {
      switch (propertyInfo.type) {
        ...
        case VECTOR:
          var vector = parsePoint(value);
          return vector.length === 0 || vector.findIndex(function (x) {
            return isNaN(x);
          }) !== -1;
      }
    }
  ...
  function getCustomPropertyInfo(name, type) {
    return customProperties.hasOwnProperty(type) && customProperties[type].hasOwnProperty(name) ? customProperties[type][name] : null;
  }
  ...
  ["children", "parent"].forEach(function (name) {
  ...
  ["autoResize", "buttonMode", "cacheAsBitmap", "interactive", "interactiveChildren", "isMask", "nativeLines", "renderable", "roundPixels", "uvRespectAnchor", "visible"].forEach(function (name) {
    properties[name] = new PropertyInfoRecord(name, BOOLEAN);
  });

  // These are PIXI attributes that must be positive numbers.
  ["alpha", "fillAlpha", "height", "lineColor", "maxWidth", "resolution", "tint", "width"].forEach(function (name) {
    properties[name] = new PropertyInfoRecord(name, POSITIVE_NUMERIC);
  });

  // These are PIXI attributes that must be numbers.
  ["boundsPadding", "clampMargin", "rotation", "x", "y"].forEach(function (name) {
    properties[name] = new PropertyInfoRecord(name, NUMERIC);
  });
  ["anchor", "pivot", "position", "scale", "skew", "tilePosition", "tileScale"].forEach(function (name) {
    properties[name] = new PropertyInfoRecord(name, VECTOR);
  });
  [
  // pixi.js < 7.0
  "added", "click", "mousedown", "mousemove", "mouseout", "mouseover", "mouseup", "mouseupoutside", "pointercancel", "pointerdown", "pointermove", "pointerout", "pointerover", "pointertap", "pointerup", "pointerupoutside", "removed", "rightclick", "rightdown", "rightup", "rightupoutside", "tap", "touchcancel", "touchend", "touchendoutside", "touchmove", "touchstart",
  // pixi.js >= 7.1
  "onclick", "onmousedown", "onmouseenter", "onmouseleave", "onmousemove", "onmouseout", "onmouseover", "onmouseup", "onmouseupoutside", "onpointercancel", "onpointerdown", "onpointerenter", "onpointerleave", "onpointermove", "onpointerout", "onpointerover", "onpointertap", "onpointerup", "onpointerupoutside", "onrightclick", "onrightdown", "onrightup", "onrightupoutside", "ontap", "ontouchcancel", "ontouchend", "ontouchendoutside", "ontouchmove", "ontouchstart", "onwheel"].forEach(function (name) {
  ...
  exports.CustomPIXIProperty = emptyFunction_1;
  {
    /**
     ...
     */
    exports.CustomPIXIProperty = function CustomPIXIProperty(maybeComponentType, propertyName, validator) {
      ...
      var componentTypeList = [].concat(maybeComponentType);
      componentTypeList.forEach(function (componentType) {
        invariant_1(Object.keys(possibleStandardNames).includes(componentType), "`%s` is not a valid component type", componentType);
        invariant_1(!(Object.keys(customProperties).includes(componentType) && Object.keys(customProperties[componentType]).includes(propertyName)) && !Object.keys(possibleStandardNames[componentType]).includes(lowerCasedPropertyName), "Property `%s` is already registered on `%s`", propertyName, componentType);
        invariant_1(typeof validator === "undefined" || typeof validator === "function", "Validator type for property `%s` is invalid. Expected `function`, got `%s`", propertyName, _typeof(validator));
  ...
  function areReactHooksAvailable() {
    return typeof React__default["default"].useEffect === "function";
  }
  function createRef() {
    return typeof React__default["default"].createRef === "function" ? /*#__PURE__*/React__default["default"].createRef() : {
      current: null
    };
  }
  function isNewContextAvailable() {
    return typeof React__default["default"].createContext === "function";
  }

  var propTypes$1 = {
    app: PropTypes__default["default"].object.isRequired,
    children: PropTypes__default["default"].node
  };
  var childContextTypes = {
    app: PropTypes__default["default"].object
  };
  exports.AppContext = null;
  function createAppProvider() {
    if (isNewContextAvailable()) {
      // New Context API
      if (exports.AppContext === null) {
        exports.AppContext = /*#__PURE__*/React__default["default"].createContext(null);
      }
      var _AppProvider = /*#__PURE__*/function (_React$Component) {
        function _AppProvider() {
          _classCallCheck(this, _AppProvider);
          return _callSuper(this, _AppProvider, arguments);
        }
        _inherits(_AppProvider, _React$Component);
        return _createClass(_AppProvider, [{
          key: "render",
          value: function render() {
            var _this$props = this.props,
              app = _this$props.app,
              children = _this$props.children;
            return /*#__PURE__*/React__default["default"].createElement(exports.AppContext.Provider, {
              value: app
            }, children);
          }
        }]);
      }(React__default["default"].Component);
      _AppProvider.propTypes = propTypes$1;
      var _withApp = function _withApp(WrappedComponent) {
        function WithApp(props) {
          return /*#__PURE__*/React__default["default"].createElement(exports.AppContext.Consumer, null, function (app) {
      ...
      var _AppProvider2 = /*#__PURE__*/function (_React$Component2) {
        function _AppProvider2() {
          ...
          return _callSuper(this, _AppProvider2, arguments);
        }
        _inherits(_AppProvider2, _React$Component2);
        return _createClass(_AppProvider2, [{
          key: "getChildContext",
      ...
      _AppProvider2.propTypes = propTypes$1;
  ...
  (function (module) {
  	...
  	{
  	  module.exports = reactReconciler_development.exports;
  	}
  } (reactReconciler));

  var ReactFiberReconciler = /*@__PURE__*/getDefaultExportFromCjs(reactReconciler.exports);

  var CHILDREN = "children";

  // http://pixijs.download/release/docs/PIXI.DisplayObject.html
  var displayObjectDefaultProps = {
    alpha: 1,
    angle: 0,
    buttonMode: false,
    cacheAsBitmap: false,
  ...
  // http://pixijs.download/release/docs/PIXI.Container.html
  var containerDefaultProps = _objectSpread2(_objectSpread2({}, displayObjectDefaultProps), {}, {
    interactiveChildren: true
  });

  // http://pixijs.download/release/docs/PIXI.Sprite.html
  var spriteDefaultProps = _objectSpread2(_objectSpread2({}, containerDefaultProps), {}, {
    anchor: 0,
    blendMode: PIXI__namespace.BLEND_MODES.NORMAL,
    pluginName: "batch",
    roundPixels: false,
    tint: 0xffffff
  });
  ...
  // http://pixijs.download/release/docs/PIXI.extras.BitmapText.html
  var bitmapTextDefaultProps = _objectSpread2(_objectSpread2({}, containerDefaultProps), {}, {
    align: "left",
    anchor: 0,
    letterSpacing: 0,
    maxWidth: 0,
  ...
  // http://pixijs.download/release/docs/PIXI.Graphics.html
  var graphicsDefaultProps = _objectSpread2(_objectSpread2({}, containerDefaultProps), {}, {
    blendMode: PIXI__namespace.BLEND_MODES.NORMAL,
    pluginName: "batch",
    tint: 0xffffff
  });
  ...
  // http://pixijs.download/release/docs/PIXI.particles.ParticleContainer.html
  var particleContainerDefaultProps = _objectSpread2(_objectSpread2({}, containerDefaultProps), {}, {
    autoResize: false,
    batchSize: 16384,
    blendMode: PIXI__namespace.BLEND_MODES.NORMAL,
    interactiveChildren: true,
  ...
  // http://pixijs.download/release/docs/PIXI.Text.html
  var textDefaultProps = _objectSpread2(_objectSpread2({}, spriteDefaultProps), {}, {
    resolution: 1,
    text: ""
  });

  // http://pixijs.download/release/docs/PIXI.extras.TilingSprite.html
  var tilingSpriteDefaultProps = _objectSpread2(_objectSpread2({}, spriteDefaultProps), {}, {
    clampMargin: 0.5,
    uvRespectAnchor: false
  });
  var defaultProps$1 = _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, TYPES.BITMAP_TEXT, bitmapTextDefaultProps), TYPES.CONTAINER, containerDefaultProps), TYPES.GRAPHICS, graphicsDefaultProps), TYPES.PARTICLE_CONTAINER, particleContainerDefaultProps), TYPES.SPRITE, spriteDefaultProps), TYPES.TEXT, textDefaultProps), TYPES.TILING_SPRITE, tilingSpriteDefaultProps);
  ...
  function getDefaultValue(type, propName) {
    var defaultValues = defaultProps$1[type];
   ...
   */
  function setValueForProperty(type, instance, propName, value, internalHandle) {
    ...
    if (shouldRemoveAttribute(type, propName, value, propertyInfo)) {
      ...
      var defaultValue = getDefaultValue(type, propName);
      if (typeof defaultValue !== "undefined") {
        value = defaultValue;
        if (strictRoot != null) {
          warning_1(false, "Received undefined for prop `%s` on `<%s />`. Setting default value to `%s`.%s", propName, type, value, getStackAddendum());
        }
      } else {
        shouldIgnoreValue = true;
        if (strictRoot != null) {
          warning_1(false, "Received undefined for prop `%s` on `<%s />`. Cannot determine default value. Ignoring.%s", propName, type, getStackAddendum());
        }
      }
    }
  ...
  function createInstance(type, props, rootContainer, hostContext, internalHandle) {
    ...
    switch (type) {
      case TYPES.BITMAP_TEXT:
        ...
        try {
          instance = new PIXI__namespace.extras.BitmapText(props.text, style);
        } catch (e) {
          instance = new PIXI__namespace.BitmapText(props.text, style);
        }
        break;
      case TYPES.CONTAINER:
        instance = new PIXI__namespace.Container();
        break;
      case TYPES.GRAPHICS:
        instance = new PIXI__namespace.Graphics();
        break;
      case TYPES.NINE_SLICE_PLANE:
        try {
          instance = new PIXI__namespace.mesh.NineSlicePlane(props.texture, props.leftWidth, props.topHeight, props.rightWidth, props.bottomHeight);
        } catch (e) {
          instance = new PIXI__namespace.NineSlicePlane(props.texture, props.leftWidth, props.topHeight, props.rightWidth, props.bottomHeight);
        }
        break;
      case TYPES.PARTICLE_CONTAINER:
        try {
          instance = new PIXI__namespace.particles.ParticleContainer(props.maxSize, props.properties, props.batchSize, props.autoResize);
        } catch (e) {
          instance = new PIXI__namespace.ParticleContainer(props.maxSize, props.properties, props.batchSize, props.autoResize);
        }
        break;
      case TYPES.SPRITE:
        instance = new PIXI__namespace.Sprite(props.texture);
        break;
      case TYPES.TEXT:
        instance = new PIXI__namespace.Text(props.text, props.style, props.canvas);
        break;
      case TYPES.TILING_SPRITE:
        try {
          instance = new PIXI__namespace.extras.TilingSprite(props.texture, props.width, props.height);
        } catch (e) {
          instance = new PIXI__namespace.TilingSprite(props.texture, props.width, props.height);
        }
        break;
      default:
        instance = createInjectedTypeInstance(type, props, rootContainer, hostContext, internalHandle, applyDisplayObjectProps);
        break;
    }
    invariant_1(instance, "ReactPixiFiber does not support the type: `%s`.", type);
    return instance;
  }
  function setInitialCustomComponentProperties(type, instance, rawProps, rootContainer, hostContext) {
    instance._customApplyProps(instance, undefined, rawProps);
  }
  function setInitialPixiProperties(type, instance, rawProps, rootContainer, hostContext) {
  ...
  function setInitialProperties(type, instance, rawProps, rootContainer, hostContext) {
    ...
    if (isInjectedType(type) && typeof instance._customApplyProps === "function") {
      setInitialCustomComponentProperties(type, instance, rawProps);
      return;
    }
    setInitialPixiProperties(type, instance, rawProps);
  }

  // Calculate the diff between the two objects.
  // See: https://github.com/facebook/react/blob/97e2911/packages/react-dom/src/client/ReactDOMFiberComponent.js#L546
  function diffProperties(type, instance, lastRawProps, nextRawProps) {
    var updatePayload = null;
  ...
  function applyDisplayObjectProps(type, instance, oldProps, newProps) {
    var updatePayload = diffProperties(type, instance, oldProps, newProps);
    if (updatePayload !== null) {
      updatePixiProperties(type, instance, updatePayload);
    }
  }
  function updateCustomComponentProperties(type, instance, updatePayload, prevProps, nextProps, internalHandle) {
    instance._customApplyProps(instance, prevProps, nextProps);
  }
  function updatePixiProperties(type, instance, updatePayload, prevProps, nextProps, internalHandle) {
  ...
  // Apply the diff.
  function updateProperties(type, instance, updatePayload, prevProps, nextProps, internalHandle) {
    // injected types with customApplyProps need to have full control over passed props
    if (isInjectedType(type) && typeof instance._customApplyProps === "function") {
      updateCustomComponentProperties(type, instance, updatePayload, prevProps, nextProps);
      return;
    }
  ...
  var validateProperty = emptyFunction_1;
  {
    var warnedProperties = {};
    var _hasOwnProperty = Object.prototype.hasOwnProperty;
    var EVENT_NAME_REGEX = /^on./;
    validateProperty = function validateProperty(type, name, value) {
      if (_hasOwnProperty.call(warnedProperties, name) && warnedProperties[name]) {
        return true;
      }
      var lowerCasedName = name.toLowerCase();
      if (EVENT_NAME_REGEX.test(name)) {
        warning_1(false, "Invalid event handler prop `%s` on `<%s />`. PIXI events use other naming convention, for example `click`.%s", name, type, getStackAddendum());
        warnedProperties[name] = true;
        return true;
      }
      if (typeof value === "number" && isNaN(value)) {
        warning_1(false, "Received NaN for prop `%s` on `<%s />`. If this is expected, cast the value to a string.%s", name, type, getStackAddendum());
        warnedProperties[name] = true;
        return true;
      }
      var propertyInfo = getPropertyInfo(name);
      var customPropertyInfo = getCustomPropertyInfo(name, type);
      var isReserved = propertyInfo !== null && propertyInfo.type === RESERVED;

      // Known attributes should match the casing specified in the property config.
      if (typeof possibleStandardNames[type] !== "undefined" && possibleStandardNames[type].hasOwnProperty(lowerCasedName)) {
        var standardName = possibleStandardNames[type][lowerCasedName];
        if (standardName !== name) {
          warning_1(false, "Invalid prop `%s` on `<%s />`. Did you mean `%s`?%s", name, type, standardName, getStackAddendum());
          warnedProperties[name] = true;
          return true;
        }
      } else if (!isReserved && typeof value !== "undefined") {
        warning_1(false, "React does not recognize prop `%s` on `<%s />`. If you accidentally passed it from a parent component, remove it from `<%s />`.%s", name, type, type, getStackAddendum());
        warnedProperties[name] = true;
        return true;
      }
  ...
  var warnUnknownProperties = function warnUnknownProperties(type, props) {
    ...
    if (unknownProps.length === 1) {
      warning_1(false, "Invalid value for prop %s on `<%s />`.%s", unknownPropString, type, getStackAddendum());
    } else if (unknownProps.length > 1) {
      warning_1(false, "Invalid values for props %s on `<%s />`.%s", unknownPropString, type, getStackAddendum());
    }
  };
  ...
  {
    validatePropertiesInDevelopment = function validatePropertiesInDevelopment(type, props, internalHandle) {
      var strictRoot = findStrictRoot(internalHandle);
      if (strictRoot != null) {
  ...
  function finalizeInitialChildren(instance, type, props, rootContainer, hostContext) {
  ...
  function prepareUpdate(instance, type, oldProps, newProps, rootContainer, hostContext) {
  ...
  function commitTextUpdate(textInstance, prevText, nextText) {
    // Noop
  }
  ...
  function unhideTextInstance(instance, props) {
    // Noop
  }
  function now() {
    return (typeof performance === "undefined" ? "undefined" : _typeof(performance)) === "object" && typeof performance.now === "function" ? function () {
  ...
  var ReactPixiFiberAsPrimaryRenderer = ReactFiberReconciler(_objectSpread2(_objectSpread2({}, hostConfig), {}, {
    isPrimaryRenderer: true
  }));

  // React Pixi Fiber renderer is secondary to React DOM renderer if used together
  var ReactPixiFiberAsSecondaryRenderer = ReactFiberReconciler(_objectSpread2(_objectSpread2({}, hostConfig), {}, {
  ...
  function validateApp(props, propName, componentName) {
    ...
    warning_1(Object.keys(options || {}).length === 0, "'options' property of '".concat(componentName, "' has no effect when 'app' property is provided. Only use 'app' or 'options', never both."));
    var isPixiApplication = app instanceof PIXI__namespace.Application;
  ...
  var propTypes = {
    ...
    options: PropTypes__default["default"].shape({
      ...
      forceFXAA: PropTypes__default["default"].bool,
      height: PropTypes__default["default"].number,
      legacy: PropTypes__default["default"].bool,
      ...
      roundPixels: PropTypes__default["default"].bool,
    ...
    children: PropTypes__default["default"].node,
    height: deprecated(PropTypes__default["default"].number, "Pass `height` in `options` prop instead."),
    width: deprecated(PropTypes__default["default"].number, "Pass `height` in `options` prop instead.")
  };
  var defaultProps = {
    options: {}
  };
  var includingContainerProps = including(Object.keys(possibleStandardNames[TYPES.CONTAINER]));
  var includingStageProps = including(Object.keys(propTypes));
  var includingCanvasProps = function includingCanvasProps(key) {
    return !includingContainerProps(key) && !includingStageProps(key);
  };
  var getCanvasProps = function getCanvasProps(props) {
    return filterByKey(props, includingCanvasProps);
  };
  var getContainerProps = function getContainerProps(props) {
    return filterByKey(props, includingContainerProps);
  };

  var render$1 = createRender(ReactPixiFiberAsSecondaryRenderer);
  var unmount$1 = createUnmount(ReactPixiFiberAsSecondaryRenderer);
  var STAGE_OPTIONS_RECREATE = false;
  var STAGE_OPTIONS_UNMOUNT = true;
  function cleanupStage(app) {
    var stageOptions = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : STAGE_OPTIONS_RECREATE;
  ...
  function getDimensions(props) {
    var _props$options = props.options,
      height = _props$options.height,
      width = _props$options.width;
    return [width, height];
  }
  function renderApp(app, props, instance) {
    var provider = /*#__PURE__*/React__default["default"].createElement(AppProvider, {
      app: app
    }, props.children);
    if (_typeof(instance) === "object") {
      render$1(provider, app.stage, undefined, instance);
    } else {
      render$1(provider, app.stage);
    }
  }
  function renderStage(app, props, instance) {
    // Determine what props to apply
    var stageProps = getContainerProps(props);
    setInitialProperties(TYPES.CONTAINER, app.stage, stageProps);
    renderApp(app, props, instance);
  }
  function rerenderStage(app, oldProps, newProps, instance) {
    // Determine what has changed
    var oldStageProps = getContainerProps(oldProps);
    var newStageProps = getContainerProps(newProps);
    var updatePayload = diffProperties(TYPES.CONTAINER, app.stage, oldStageProps, newStageProps);
    if (updatePayload !== null) {
      updateProperties(TYPES.CONTAINER, app.stage, updatePayload);
    }
    renderApp(app, newProps, instance);
  }
  function resizeRenderer(app, oldProps, newProps) {
    var _getDimensions = getDimensions(oldProps),
      _getDimensions2 = _slicedToArray(_getDimensions, 2),
      oldWidth = _getDimensions2[0],
      oldHeight = _getDimensions2[1];
    var _getDimensions3 = getDimensions(newProps),
      _getDimensions4 = _slicedToArray(_getDimensions3, 2),
      newWidth = _getDimensions4[0],
      newHeight = _getDimensions4[1];
    if (newHeight !== oldHeight || newWidth !== oldWidth) {
      app.renderer.resize(newWidth, newHeight);
    }
  }

  var _excluded$1 = ["height", "width"],
    _excluded2$1 = ["height", "width"];
  function usePreviousProps(value) {
    var props = React.useRef(emptyObject_1);
    React.useEffect(function () {
      props.current = value;
    });
    return props.current;
  }
  function useStageRenderer(props, appRef, canvasRef) {
    // create app on mount
    React.useLayoutEffect(function () {
      ...
      if (app != null) {
        invariant_1(app instanceof PIXI__namespace.Application, "Provided `app` has to be an instance of PIXI.Application");
        appRef.current = app;
  ...
  function useStageRerenderer(props, appRef, canvasRef) {
    ...
    React.useLayoutEffect(function () {
      ...
      if (!appRef.current || prevProps === emptyObject_1) return;
      var app = props.app;
      ...
      if (!shallowEqual_1(otherOptions, prevOtherOptions)) {
    ...
    var Stage = /*#__PURE__*/function (_React$Component) {
      ...
      return _createClass(Stage, [{
        ...
        value: function componentDidMount() {
          var app = this.getPixiApplication(this.props);
        ...
        key: "getPixiApplication",
        value: function getPixiApplication(props, prevProps) {
          var app = props.app,
            options = props.options;
          ...
          var _props$options = props.options;
            _props$options.height;
            _props$options.width;
            var otherOptions = _objectWithoutProperties(_props$options, _excluded);
          var _prevProps$options = prevProps.options;
            _prevProps$options.height;
            _prevProps$options.width;
            var prevOtherOptions = _objectWithoutProperties(_prevProps$options, _excluded2);
        ...
        key: "renderStage",
        value: function renderStage$1(app, props) {
        ...
        key: "rerenderStage",
        value: function rerenderStage$1(app, props, prevProps) {
          ...
          // Update canvas and renderer dimestions
          if (!(props.app instanceof PIXI__namespace.Application)) {
  ...
  var index = areReactHooksAvailable() ? createStageFunction() : createStageClass();

  function usePixiApp() {
    var app = React.useContext(exports.AppContext);
    if (app === null) {
  ...
  var render = createRender(ReactPixiFiberAsPrimaryRenderer);
  var unmount = createUnmount(ReactPixiFiberAsPrimaryRenderer);
  var BitmapText = TYPES.BITMAP_TEXT;
  var Container = TYPES.CONTAINER;
  var Graphics = TYPES.GRAPHICS;
  var NineSlicePlane = TYPES.NINE_SLICE_PLANE;
  ...
  exports.applyDisplayObjectProps = applyDisplayObjectProps;
  exports.createStageClass = createStageClass;
  exports.render = render;
  exports.unmount = unmount;
  exports.unstable_batchedUpdates = unstable_batchedUpdates;
  exports.usePixiApp = usePixiApp;
  exports.usePixiTicker = usePixiTicker;
