...
import React, { version, forwardRef, useRef, useImperativeHandle, useLayoutEffect, useEffect, useContext } from 'react';
...
var CustomPIXIProperty = emptyFunction_1;
{
  /**
...
function createRef() {
  return typeof React.createRef === "function" ? /*#__PURE__*/React.createRef() : {
    current: null
  };
}
...
function createInstance(type, props, rootContainer, hostContext, internalHandle) {
  ...
  switch (type) {
    ...
    case TYPES.NINE_SLICE_PLANE:
      try {
        instance = new PIXI.mesh.NineSlicePlane(props.texture, props.leftWidth, props.topHeight, props.rightWidth, props.bottomHeight);
      } catch (e) {
        instance = new PIXI.NineSlicePlane(props.texture, props.leftWidth, props.topHeight, props.rightWidth, props.bottomHeight);
      }
      break;
...
function validateApp(props, propName, componentName) {
  ...
  var isPixiApplication = app instanceof PIXI.Application;
...
function usePreviousProps(value) {
  var props = useRef(emptyObject_1);
  useEffect(function () {
    props.current = value;
  });
...
function useStageRenderer(props, appRef, canvasRef) {
  ...
  useLayoutEffect(function () {
    ...
    if (app != null) {
      invariant_1(app instanceof PIXI.Application, "Provided `app` has to be an instance of PIXI.Application");
      appRef.current = app;
...
function createStageFunction() {
  var Stage = /*#__PURE__*/forwardRef(function Stage(props, ref) {
    var app = props.app,
      options = props.options;
...
export { AppContext, AppProvider, BitmapText, Container, CustomPIXIComponent, CustomPIXIProperty, Graphics, NineSlicePlane, ParticleContainer, Sprite, index as Stage, Text, TilingSprite, applyDisplayObjectProps, createStageClass, render, unmount, unstable_batchedUpdates, usePixiApp, usePixiTicker, withApp };
